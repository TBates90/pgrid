...
@needs_models
def test_compute_pg_to_macro_edge_map_is_bijection_for_corner_grids():
    from polygrid.tile_uv_align import compute_pg_to_macro_edge_map
    ...
    # Pick one face with explicit corner IDs (pentagon detail grid path).
    face_id = None
    detail_grid = None
    ...
    mapping = compute_pg_to_macro_edge_map(grid, face_id, detail_grid)
